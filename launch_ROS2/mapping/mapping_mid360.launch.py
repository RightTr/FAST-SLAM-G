...
rviz_cfg = os.path.join(get_package_share_directory("fast_slam_g"), "rviz_cfg", "loam_ros2.rviz" )

print(rviz_cfg)

config_file = os.path.join(
    get_package_share_directory("fast_slam_g"), "config", "mapping", "mid360.yaml"
)
